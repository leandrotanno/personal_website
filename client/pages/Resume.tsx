      ...
      <article className="mx-auto max-w-3xl rounded-xl border border-violet-200/30 bg-white/5 p-6 backdrop-blur print-card print-no-border">
        ...
        <header className="mb-5 grid gap-4 sm:grid-cols-[200px_1fr_1fr]">
          ...
          <div className="rounded-lg border border-violet-300/40 bg-violet-50/30 p-2 print-card">
            ...
            <div className="text-xl font-extrabold tracking-tight text-slate-900 dark:text-white print-muted">
              {profileData.name}
            </div>
            <p className="mt-1 text-sm text-slate-700/90 dark:text-violet-100/85 print-muted">
              {profileData.bio}
            </p>
          </div>
          <div className="rounded-lg border border-violet-300/40 bg-violet-50/30 p-2 print-card">
          ...
          <div className="mt-3 space-y-4">
            <div className="rounded-lg border border-slate-200/50 bg-slate-50/50 p-4 dark:border-violet-700/30 dark:bg-violet-900/10 print-card">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div className="font-semibold text-slate-900 dark:text-violet-100 print-muted">
                  Analytics Engineer
                </div>
                <div className="text-xs text-slate-600 dark:text-violet-200/70 print-muted">
                  2019 — Presente
                </div>
              </div>
              <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-slate-800 dark:text-violet-100/85 print-muted">
                <li>
                  Projetos de web analytics end-to-end e automações de dados
                </li>
