...
export function Logo({ className = "", size = 32 }: LogoProps) {
  return (
    ...
    >
      ...
      <path d="M6 20L10 16L14 18L18 12L22 14L26 10" stroke="#34d399" strokeWidth="2" fill="none" strokeLinecap="round"/>
      <path d="M6 24L10 22L14 20L18 16L22 18L26 14" stroke="#a78bfa" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
